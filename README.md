[![Run App PierreMansour](https://github.com/PierreRaoof/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/PierreRaoof/GithubActions/actions/workflows/run-app.yaml)
